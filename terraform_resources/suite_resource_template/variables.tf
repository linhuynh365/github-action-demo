...
variable "environment_type" {
  ...
  nullable    = false
  validation {
    condition     = contains(["central", "dev", "nonprod", "prod"], var.environment_type)
...
#   nullable    = true
#   type        = list(string)
#   description = "List of Vnets to be whitelisted in keyvault firewall rules."
#   default     = []
# }

variable "subscription_id" {
  description = "The subscription id where the resources should be provisioned."
  nullable    = false
  type        = string
}
